...
const LocationEnvironment1 = () => {
  ...
  return (
    ...
    <Helmet>
      ...
      {/* SEO 핵심 */}
      <title>모종 삼일 파라뷰- 프리미엄</title>
      <meta
        name="description"
        content="모종 삼일 파라뷰프리미엄을 확인하세요. 단지 설계, 커뮤니티, 생활 편의 등 주거의 가치를 높이는 핵심 포인트를 소개합니다."
      />
      <meta
        name="keywords"
      ...
      <meta property="og:title" content="모종 삼일 파라뷰- 프리미엄" />
      <meta
      ...
      <meta name="twitter:title" content="모종 삼일 파라뷰- 프리미엄" />
      <meta
    ...
    <p className={styles.screenReaderOnly}>
      모종 삼일 파라뷰만의 프리미엄을 소개합니다.
      단지 설계, 커뮤니티 구성 등 주거의 가치를 높이는 핵심 포인트를 확인하세요.
    </p>

    <div className={styles.textBox}>
      <div>주거의 가치를 높이는 프리미엄 라이프</div>
      <div>모종 삼일 파라뷰프리미엄</div>
    </div>

        <img
          src={page1}
          className={styles.image3}
          alt="모종 삼일 파라뷰프리미엄 이미지 1"
        />
