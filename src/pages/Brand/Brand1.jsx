...
const Brand1 = () => {
    ...
    return (
        ...
        <Helmet>
          ...
          {/* Primary SEO */}
          <title>모종 삼일 파라뷰- 브랜드 소개</title>
          <meta
            name="description"
            content="모종 삼일 파라뷰의 브랜드 가치와 주거 철학을 소개합니다. 아산 모종 생활권의 새로운 주거 기준을 확인해보세요."
          />
          <meta
            name="keywords"
          ...
          <meta property="og:title" content="모종 삼일 파라뷰- 브랜드 소개" />
          <meta
          ...
          <meta name="twitter:title" content="모종 삼일 파라뷰- 브랜드 소개" />
          <meta
        ...
        <p className={styles.screenReaderOnly}>
          모종 삼일 파라뷰는 새로운 주거 가치를 바탕으로 설계, 공간, 라이프스타일까지
          세심하게 담아낸 주거공간을 제안합니다.
          이 페이지에서는 브랜드 가치와 주거 철학을 소개합니다.
        </p>

        <div className={`${styles.textBox} ${isTextVisible ? styles.active : ''}`}>
          <div>새로운 주거 가치를 담은 프리미엄 라이프</div>
          <div>모종 삼일 파라뷰에서 만나다</div>
        </div>


            <img className={`${styles.image} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="모종 삼일 파라뷰 brand-Image1" />
