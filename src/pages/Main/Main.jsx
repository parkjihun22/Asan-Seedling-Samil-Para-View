...
<div className={styles.imageContainer}>
  ...
  <div className={styles.mainImageTextBox}>
    <div className={styles.mainImageTextSub}>
      아산 모종 중심 입지
      <span className={styles.greyText}> 프리미엄 생활 인프라</span> |
      편리한 교통 환경
      <span className={styles.greyText}> 쾌적한 주거 환경</span> |
      품격 있는 라이프스타일
      <span className={styles.greyText}> 모종 삼일 파라뷰</span>
    </div>

    <div className={styles.mainImageTitleBox}>
      <div className={styles.mainImageText}>
        아산 모종에서 시작되는 새로운 주거 가치
      </div>
        ...
        모종 삼일 파라뷰
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 아산 모종 생활권 중심 입지에서 누리는 편리한 주거 환경<br />
                  - 온양온천역 및 주요 도로망 인접으로 편리한 교통 환경<br />
                  - 다양한 생활 인프라와 가까운 편리한 생활환경<br />
                  - 차별화된 공간 설계로 높아지는 주거 만족도<br />
                  - 안정적인 거주가 가능한 8년 민간임대 아파트
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="모종 삼일 파라뷰 브랜드소개-image4"
                />
                <div className={styles.text1}>모종 삼일 파라뷰</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/maqlbzan"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="모종 삼일 파라뷰 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              ...
              생활 인프라를 가까이 누리는
              <br />
              <span className={styles.greyText1}>편리한 주거 환경</span>
              <br />
              새로운 주거 가치를 제안하는
              <br />
              <span className={styles.greyText1}>모종 삼일 파라뷰</span>
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이파라뷰 다른
                <br />
                프리미엄 주거라이프를 <br /> 모종 삼일 파라뷰에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="모종 삼일 파라뷰 모바일 조감도 이미지"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="모종 삼일 파라뷰 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="모종 삼일 파라뷰 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
