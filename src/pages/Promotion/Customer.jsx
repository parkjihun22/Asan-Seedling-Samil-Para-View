...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/maqlbzan", {
        method: "POST",
...
<Helmet>
        ...
        {/* Primary SEO */}
        <title>모종 삼일 파라뷰– 관심고객 등록</title>
        <meta
          name="description"
          content="모종 삼일 파라뷰관심고객 등록 페이지입니다. 분양 일정 및 주요 안내 소식을 빠르게 받아보고, 상담 요청을 남겨보세요."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="모종 삼일 파라뷰– 관심고객 등록" />
        <meta
        ...
        <meta name="twitter:title" content="모종 삼일 파라뷰– 관심고객 등록" />
        <meta
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>모종 삼일 파라뷰</h2>
