...
const ComplexGuide1 = () => {
  ...
  return (
    ...
    <Helmet>
      ...
      {/* SEO 핵심 */}
      <title>모종 삼일 파라뷰- 호수배치도</title>
      <meta
        name="description"
        content="모종 삼일 파라뷰호수배치도를 통해 동별 세대 위치와 배치 구조를 확인하세요."
      />
      <meta
        name="keywords"
      ...
      <meta property="og:title" content="모종 삼일 파라뷰- 호수배치도" />
      <meta
      ...
      <meta name="twitter:title" content="모종 삼일 파라뷰- 호수배치도" />
      <meta
    ...
    <p className={styles.screenReaderOnly}>
      호수배치도 페이지는 모종 삼일 파라뷰의 세대별 위치와 배치 구조를 안내합니다.
      각 동과 호수의 배치를 통해 세대 선택 시 참고할 수 있는 정보를 제공합니다.
    </p>

    <div className={styles.textBox}>
      <div>세대 선택을 위한 배치 정보</div>
      <div>모종 삼일 파라뷰호수배치도</div>
    </div>
